...
@Component({
  selector: 'app-ac-milan',
  templateUrl: './ac-milan.component.html',
  styleUrls: ['./ac-milan.component.css']
})
export class AcMilanComponent implements OnInit {
  ...
  logged:any;
  ngOnInit(): void {
    this.type = this.service.acMilan;
