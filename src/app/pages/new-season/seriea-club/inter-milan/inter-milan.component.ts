...
@Component({
  selector: 'app-inter-milan',
  templateUrl: './inter-milan.component.html',
  styleUrls: ['./inter-milan.component.css']
})
export class InterMilanComponent implements OnInit {
  ...
  logged:any;
  ngOnInit(): void {
    this.type = this.service.interMilan;
