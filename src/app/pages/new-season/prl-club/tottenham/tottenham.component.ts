...
@Component({
  selector: 'app-tottenham',
  templateUrl: './tottenham.component.html',
  styleUrls: ['./tottenham.component.css']
})
export class TottenhamComponent implements OnInit {
  ...
  myItems: any[] = [];
  ngOnInit(): void {
    this.type = this.service.Tottenham;
