...
@Component({
  selector: 'app-villareal',
  templateUrl: './villareal.component.html',
  styleUrls: ['./villareal.component.css']
})
export class VillarealComponent implements OnInit {
  ...
  myItems: any[] = [];
  ngOnInit(): void {
    this.type = this.service.Villareal;
