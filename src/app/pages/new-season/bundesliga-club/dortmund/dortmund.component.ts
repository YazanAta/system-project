...
@Component({
  selector: 'app-dortmund',
  templateUrl: './dortmund.component.html',
  styleUrls: ['./dortmund.component.css']
})
export class DortmundComponent implements OnInit {
  ...
  myItems: any[] = [];
  ngOnInit(): void {
    this.type = this.service.Dortmund;
