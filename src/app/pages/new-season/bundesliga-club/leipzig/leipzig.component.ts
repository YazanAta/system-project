...
@Component({
  selector: 'app-leipzig',
  templateUrl: './leipzig.component.html',
  styleUrls: ['./leipzig.component.css']
})
export class LeipzigComponent implements OnInit {
  ...
  myItems: any[] = [];
  ngOnInit(): void {
    this.type = this.service.Leipzig;
